      ...
      <Tailwind config={{ presets: [pixelBasedPreset] }}>
        ...
        <Body className="bg-gray-100 font-sans">
          <Container className="mx-auto py-40 px-20 max-w-600">
            <Heading className="text-24 font-bold text-gray-800">
              {t('subject')}
            </Heading>
            ...
            <Button
              ...
              className="bg-blue-600 text-white px-20 py-12 rounded block text-center no-underline box-border"
            >
              {t('cta')}
            </Button>
...
export default async function WelcomeEmail({
  ...
  return (
    <Html lang={locale}>
      <Tailwind config={{ presets: [pixelBasedPreset] }}>
        <Body className="bg-gray-100 font-sans">
          <Container className="mx-auto p-20 max-w-600">
            <Text className="text-16 text-gray-800">
            ...
            <Button
              ...
              className="bg-blue-600 text-white px-20 py-12 rounded box-border"
            >
      ...
      <Tailwind config={{ presets: [pixelBasedPreset] }}>
        ...
        <Body className="bg-gray-100 font-sans">
          <Container className="mx-auto py-40 px-20 max-w-600">
            ...
            <Text className="text-16 text-gray-800 my-8">
              {t('order-number')}: {orderNumber}
            </Text>
            <Text className="text-16 text-gray-800 my-8">
              {t('order-date')}: {dateFormatter.format(orderDate)}
            </Text>
            <Section className="bg-white p-20 rounded my-16">
              <Text className="text-20 font-bold text-gray-800">
                {t('total')}: {currencyFormatter.format(total)}
              </Text>
            </Section>
            <Button
              href={`https://example.com/orders/${orderNumber}`}
              className="bg-blue-600 text-white px-20 py-12 rounded block text-center no-underline my-20 box-border"
            >
              {t('view-order')}
            </Button>
            <Hr className="border-gray-200 my-20" />
