    ...
    expect(actualOutput).toMatchInlineSnapshot(`
      ...
      <html dir="ltr" lang="en">
        <head>
          ...
          <!--$-->
          <style>
            @media (min-width:640px){.sm_bg-red-50{background-color:rgb(254,242,242)!important}.sm_text-sm{font-size:0.875rem!important;line-height:1.4285714285714286!important}}@media (min-width:768px){.md_text-lg{font-size:1.125rem!important;line-height:1.5555555555555556!important}}
          </style></head
        ><span
  ...
  it('works with calc() with + sign', async () => {
    ...
    expect(actualOutput).toMatchInlineSnapshot(`
      ...
      <head>
        <!--$-->
        <style>
          @media (min-width:1024px){.lg_max-h-calc50pxplus5rem{max-height:calc(50px + 5rem)!important}}
        </style>
      </head>
      <div
    ...
    */
    it('works with arbitrarily deep (in the React tree) <head> elements', async () => {
      expect(
        ...
        <html lang="en">
          <head>
            <!--$-->
            <style>
              @media (min-width:640px){.sm_bg-red-300{background-color:rgb(255,162,162)!important}}@media (min-width:768px){.md_bg-red-400{background-color:rgb(255,100,103)!important}}@media (min-width:1024px){.lg_bg-red-500{background-color:rgb(251,44,54)!important}}
            </style>
          </head>
          <body>
            <div
      ...
      expect(
        ...
        `"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html lang="en"><head><!--$--><style>@media (min-width:640px){.sm_bg-red-300{background-color:rgb(255,162,162)!important}}@media (min-width:768px){.md_bg-red-400{background-color:rgb(255,100,103)!important}}@media (min-width:1024px){.lg_bg-red-500{background-color:rgb(251,44,54)!important}}</style></head><body><div class="sm_bg-red-300 md_bg-red-400 lg_bg-red-500" style="background-color:rgb(255,201,201)"></div><!--/$--></body></html>"`,
      );
    });
      ...
      expect(actualOutput).toMatchInlineSnapshot(`
        ...
        <html lang="en">
          <head>
            <!--$-->
            <style>
              @media (min-width:640px){.text-body{color:darkgreen!important}}
            </style>
          </head>
          <body>
      ...
      expect(actualOutput).toMatchInlineSnapshot(`
        ...
        <html lang="en">
          <head>
            <!--$-->
            <style>
              @media (hover:hover){.hover_bg-red-600:hover{background-color:rgb(231,0,11)!important}}.focus_bg-red-700:focus{background-color:rgb(193,0,7)!important}@media (min-width:640px){.sm_bg-red-300{background-color:rgb(255,162,162)!important}@media (hover:hover){.sm_hover_bg-red-200:hover{background-color:rgb(255,201,201)!important}}}@media (min-width:768px){.md_bg-red-400{background-color:rgb(255,100,103)!important}}@media (min-width:1024px){.lg_bg-red-500{background-color:rgb(251,44,54)!important}}
            </style>
          </head>
          <body>
            <div
    ...
    it('works with relatively complex media query utilities', async () => {
      ...
      expect(await render(<Email />).then(pretty)).toMatchInlineSnapshot(`
        ...
        <head>
          ...
          <!--$-->
          <style>
            @media (max-width:639.98px){.max-sm_text-red-600{color:rgb(231,0,11)!important}}
          </style>
        </head>
      ...
      expect(actualOutput).toMatchInlineSnapshot(`
        ...
        <html lang="en">
          <head>
            <!--$-->
            <style>
              @media (min-width:640px){.sm_bg-red-500{background-color:rgb(251,44,54)!important}}
            </style>
            <style></style>
            <link />
          </head>
      ...
      expect(actualOutput).toMatchInlineSnapshot(`
        ...
        <html lang="en">
          <head>
            <!--$-->
            <style>
              @media (min-width:640px){.sm_border-custom{border:2px solid!important}}
            </style>
          </head>
          <body>
