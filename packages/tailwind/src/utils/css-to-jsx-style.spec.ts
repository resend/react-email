...
describe("cssToJsxStyle function", () => {
  it("transforms a rule", () => {
    expect(cssToJsxStyle("color: red")).toEqual({ color: "red" });
  });

  it("transforms multiple rules", () => {
  ...
  it("transforms no rules", () => {
    expect(cssToJsxStyle("")).toEqual({});
    expect(cssToJsxStyle("   ")).toEqual({});
    expect(cssToJsxStyle(" : ;; :;: ;")).toEqual({});
  });

  it("transforms rules with browser prefixes", () => {
    expect(
  ...
  it("transforms float rule property to cssFloat", () => {
    expect(cssToJsxStyle("float: left")).toEqual({ cssFloat: "left" });
  });

  it("transforms rules with urls", () => {
    expect(
      cssToJsxStyle(
  ...
  it("transforms rules with dataurls", () => {
    expect(
  ...
  it("transforms rules with quoted ';' in value", () => {
    expect(
  ...
  it("transforms rule properties of any case to camelCase", () => {
    expect(
  ...
  it("transforms custom properties", () => {
