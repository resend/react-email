...
const paragraphClassnames =
  "text-gray-600 text-base font-[HelveticaNeue,Helvetica,Arial,sans-serif] tracking-[0] leading-6 p-[0_40px] m-0 text-center";
  ...
  <Html>
    <Tailwind config={tailwindConfig}>
      ...
      <Body className="bg-white font-[HelveticaNeue,Helvetica,Arial,sans-serif]">
        ...
        <Text className="text-black text-xs font-extrabold tracking-[0] leading-6 m-0 mt-5 font-[HelveticaNeue,Helvetica,Arial,sans-serif] uppercase text-center">
