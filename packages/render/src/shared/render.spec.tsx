...
describe("render", () => {
  it("converts a React component into HTML", () => {
    ...
    expect(actualOutput).toMatchInlineSnapshot(
      '"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><h1>Welcome, Jim!</h1><link rel="preload" as="image" href="img/test.png"/><img alt="test" src="img/test.png"/><p>Thanks for trying our product. We&#x27;re thrilled to have you on board!</p>"',
    );
  });
