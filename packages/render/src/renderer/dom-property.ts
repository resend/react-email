/**
  * This is basically the same what is in
  * https://github.com/facebook/react/blob/18-3-1/packages/react-dom/src/shared/DOMProperty.js.
  */
  ...
  if (propertyInfo !== null) {
    ...
    switch (propertyInfo.type) {
      ...
      case POSITIVE_NUMERIC:
        return Number.isNaN(value) || (value as number) < 1;
      default:
    }
  }
  return false;
