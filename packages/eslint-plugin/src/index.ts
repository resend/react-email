...
import { noUnsupportedOnGmailIOS, noPartiallyUnsupportedOnGmailIOS } from "./rules";
import { getAllSupportEntrries } from "./data/get-all-support-entries";

const caniemailSupportEntries = getAllSupportEntrries();

const rules = {
  'no-unsupported-on-gmail-ios': noUnsupportedOnGmailIOS(caniemailSupportEntries),
  'no-partially-supported-on-gmail-ios': noPartiallyUnsupportedOnGmailIOS(caniemailSupportEntries)
