  ...
  return (
    ...
    >
      <Popover.Trigger asChild>
        <button
          className="box-border flex h-5 w-20 items-center justify-center self-center rounded-lg border border-slate-6 bg-slate-2 px-4 py-4 text-center font-sans text-slate-11 text-sm outline-none transition duration-300 ease-in-out hover:border-slate-10 hover:text-slate-12"
          type="submit"
        >
          Send
        </button>
      ...
      <Popover.Portal>
        ...
        >
          <form className="mt-1" onSubmit={(e) => void onFormSubmit(e)}>
            <label
              className="mb-2 block text-slate-10 text-xs uppercase"
              htmlFor="to"
            >
              Recipient
            </label>
            ...
            />
            <label
              className="mt-1 mb-2 block text-slate-10 text-xs uppercase"
              htmlFor="subject"
            >
              Subject
            </label>
