      ...
      <div className="mt-auto p-4 border-t border-(--re-border)">
        ...
        >
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M2.5 1.75H5.25C5.71413 1.75 6.15925 1.93437 6.48744 2.26256C6.81563 2.59075 7 3.03587 7 3.5V12.25C7 11.9185 6.8683 11.6005 6.63388 11.3661C6.39946 11.1317 6.08152 11 5.75 11H2.5V1.75Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M11.5 1.75H8.75C8.28587 1.75 7.84075 1.93437 7.51256 2.26256C7.18437 2.59075 7 3.03587 7 3.5V12.25C7 11.9185 7.1317 11.6005 7.36612 11.3661C7.60054 11.1317 7.91848 11 8.25 11H11.5V1.75Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          Documentation
        </a>
      </div>
