...
import { stripExampleShell } from './strip-example-shell';
    ...
    examples: [
      {
        ...
        sourceCode: stripExampleShell(oneLineEditorSource),
      ...
      },
      {
        ...
        sourceCode: stripExampleShell(oneLineEditorFullSource),
        docsUrl: 'https://react.email/docs/editor/getting-started',
      },
    ],
  },
    ...
    examples: [
      {
        ...
        sourceCode: stripExampleShell(basicEditorSource),
        docsUrl: 'https://react.email/docs/editor/getting-started',
      },
      {
        id: 'bubble-menu',
        ...
        sourceCode: stripExampleShell(bubbleMenuSource),
      ...
      },
      {
        ...
        sourceCode: stripExampleShell(slashCommandsSource),
    ...
    examples: [
      {
        ...
        sourceCode: stripExampleShell(customBubbleMenuSource),
        docsUrl: 'https://react.email/docs/editor/features/bubble-menu',
      },
      {
        id: 'link-editing',
        ...
        sourceCode: stripExampleShell(linkEditingSource),
      ...
      },
      {
        ...
        sourceCode: stripExampleShell(columnLayoutsSource),
      ...
      },
      {
        ...
        label: 'Buttons',
        component: Buttons,
        sourceCode: stripExampleShell(buttonsSource),
    ...
    examples: [
      {
        ...
        sourceCode: stripExampleShell(emailThemingSource),
      ...
      },
      {
        ...
        sourceCode: stripExampleShell(emailExportSource),
      ...
      },
      {
        ...
        sourceCode: stripExampleShell(customExtensionsSource),
      ...
      },
      {
        ...
        sourceCode: stripExampleShell(inspectorDefaultsSource),
      ...
      },
      {
        ...
        sourceCode: stripExampleShell(inspectorComposedSource),
        docsUrl: 'https://react.email/docs/editor/overview',
      },
      {
        id: 'inspector-custom',
        ...
        sourceCode: stripExampleShell(inspectorCustomSource),
        docsUrl: 'https://react.email/docs/editor/overview',
      },
      {
        ...
        sourceCode: stripExampleShell(fullEmailBuilderSource),
        docsUrl: 'https://react.email/docs/editor/features/email-export',
      },
    ],
  },
