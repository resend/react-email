...
export default function Preview({ navItems, slug, markup, reactMarkup, plainText }) {
      ...
      {activeView === 'desktop' ? (
        ...
        <div className="flex gap-6 mx-auto p-6 max-w-3xl">
          <Tooltip.Provider>
            <CodeContainer
              markups={[
                { content: reactMarkup, language: 'jsx' },
                { content: markup, language: 'markup' },
                { content: plainText, language: 'markdown' }
              ]}
