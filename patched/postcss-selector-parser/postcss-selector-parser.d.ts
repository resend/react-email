...
declare function parser<Transform>(
  processor: parser.AsyncProcessor<Transform>,
): parser.Processor<Transform, never>;
declare function parser(
  processor: parser.AsyncProcessor<void>,
): parser.Processor<never, never>;
declare function parser<Transform>(
  processor: parser.SyncProcessor<Transform>,
): parser.Processor<Transform>;
declare function parser(
  processor: parser.SyncProcessor<void>,
): parser.Processor<never>;
declare function parser<Transform>(
  processor?:
    | parser.SyncProcessor<Transform>
    | parser.AsyncProcessor<Transform>,
): parser.Processor<Transform>;
...
declare namespace parser {
  ...
  interface Namespace<Value extends string | undefined = string>
    extends Base<Value> {
    /** alias for namespace */
    ns: string | true;
    /**
