    ...
    <Body style={{
      ...
      <Container style={{
        ...
        <Heading style={{
          ...
          margin: "40px 0",
          padding: "0",
        }}>Hey, Gabriel Miranda,</Heading>

        <Text style={paragraphStyle}>This is the code that has the issue, can you please take a look into fixing it?</Text>
        <CodeBlock
          code={code}
          theme={themes.dracula}
          language="rust"
        />
        <Text style={paragraphStyle}>It seems that the problem is very critical, if you can solve it as quickly as possible that would be awesome!</Text>
        <br/>
        <Text style={paragraphStyle}>Thanks in advance, <br/>Someone Jr</Text>
      </Container>
    </Body>
  </Html>;
};
