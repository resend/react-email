...
export const OrderDeliveredEmail = ({
  ...
  deliveredOn = 'Monday, April 28, 2026',
  deliveryNote = 'Left at front door',
  reviewUrl = demoDefaultExternalUrl,
  ...
  <Html dir="ltr" lang="en">
    ...
    <Tailwind config={tailwindConfig}>
      <Body className="bg-[#f4f4f5] m-0 p-0 font-amazon text-[14px] text-[#3f3f46]">
        <Preview>
          Your order #{orderNumber} has arrived! We hope you love it.
        </Preview>
        ...
        <Container className="max-w-[600px] mx-auto my-[32px] bg-white border border-[#e4e4e7]">
          ...
          <Section className="px-[48px] py-[40px]">
            ...
            <Text className="text-[14px] leading-[1.625] text-[#71717a] mt-0 mb-[32px]">
              ...
              you have any questions or concerns, don&apos;t hesitate to reach
              out.
            </Text>
            ...
            <Section className="bg-[#fafafa] border border-[#f4f4f5] px-[20px] py-[16px] mb-[32px]">
              ...
              <Row className="pb-[8px]">
                ...
                <Column
                  align="right"
                  className="text-[13px] text-[#27272a] font-semibold"
                >
                  {deliveredOn}
                </Column>
              </Row>
              <Row>
                <Column className="text-[13px] text-[#71717a]">Note</Column>
                <Column
                  align="right"
            ...
            <Section className="text-center bg-[#fafafa] border border-[#f4f4f5] px-[20px] py-[24px] mb-[32px]">
              <Text className="text-[15px] leading-[24px] font-semibold text-[#18181b] mt-0 mb-[4px]">
                Enjoying your purchase?
              </Text>
              <Text className="text-[13px] leading-[1.5] text-[#71717a] mt-0 mb-[16px]">
                Your feedback helps other customers make better decisions.
              </Text>
              <Button
                href={reviewUrl}
                className="bg-[#18181b] text-white text-[13px] font-medium px-[20px] py-[10px]"
              >
                Leave a review ★
              </Button>
            </Section>
