          ...
          <Container className="p-5 mx-auto bg-[#eee]">
            <Section className="bg-white">
              ...
              <Section className="py-6 px-9">
                ...
                <Text className="mb-3.5 text-[#333] text-sm my-6 mx-0">
                ...
                <Section className="flex items-center justify-center">
                  <Text className="text-[#333] m-0 font-bold text-center text-sm">
                    Verification code
                  </Text>

                  <Text className="text-[#333] text-4xl my-2.5 mx-0 font-bold text-center">
                    {verificationCode}
                  </Text>
                  <Text className="text-[#333] text-sm m-0 text-center">
            ...
            <Text className="text-[#333] text-xs my-6 mx-0 px-5 py-0">
              ...
              <Link
                ...
                target="_blank"
                className="text-[#2754C5] underline text-sm"
              >
                Amazon.com
              </Link>
              , Inc. View our{' '}
