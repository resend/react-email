      ...
      <div>
        <div className="absolute w-full">
          <nav className="max-w-6xl mx-auto px-6 flex items-center justify-between mt-6 mb-4">
            <a href="/">
              <svg width="24" height="24" viewBox="0 0 107 106" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex">
              <a href="https://github.com/zenorocha/react-email" target="_blank" rel="noreferrer" aria-selected="false" className="p-2 text-current transition duration-300 ease-in-out hover:opacity-60">
              ...
              <a href="/discord" target="_blank" rel="noreferrer" aria-selected="false" className="p-2 text-current transition duration-300 ease-in-out hover:opacity-60">
