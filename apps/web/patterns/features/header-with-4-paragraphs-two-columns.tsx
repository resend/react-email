...
export const title = "Header with four paragraphs and two columns";

export const HeaderWithFourParagraphsTwoColumns = () => {
  return (
    <Layout>
      {/* start pattern code */}
...
export default HeaderWithFourParagraphsTwoColumns;
