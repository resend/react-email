      ...
      <TooltipProvider>
        ...
        <div className="relative h-fit w-full transition-all duration-300 ease-[cubic-bezier(.36,.66,.6,1)] transition-discrete">
          <TabContent value="desktop" className="min-h-[228px]">
            <div className="absolute inset-0 bg-[radial-gradient(#091A21_.0313rem,transparent_.0313rem),radial-gradient(#091A21_.0313rem,transparent_.0313rem)] bg-transparent opacity-30 transition-all duration-300 ease-[cubic-bezier(.36,.66,.6,1)] bg-position-[0_0,.625rem_.625rem] bg-size-[1.25rem_1.25rem] h-[calc-size(auto)] transition-discrete" />
