    ...
    <PageWrapper>
      ...
      <PageTransition className="pb-10" key="about" tag="main">
        ...
        <div className="relative grid grid-cols-1 gap-x-4 px-1 pb-10 md:grid-cols-2 md:px-0 lg:grid-cols-3">
          <div className="-translate-x-1/2 absolute top-0 left-1/2 h-px w-dvw border-slate-4 border-t xl:mask-[linear-gradient(to_right,transparent_0%,black_10%,black_90%,transparent_100%)]" />
          <div className="-translate-x-1/2 absolute bottom-0 left-1/2 h-px w-dvw border-slate-4 border-b xl:mask-[linear-gradient(to_right,transparent_0%,black_10%,black_90%,transparent_100%)]" />
            ...
            return (
              <Link
                className={classNames(
                  'group relative isolate mt-7 cursor-pointer scroll-m-6 rounded-md focus:outline-hidden focus:ring-3 focus:ring-slate-2 md:before:absolute md:before:inset-0 md:before:rounded-md md:before:border md:before:border-slate-4 md:before:border-dashed md:before:transition-colors md:before:duration-720 md:before:ease-[cubic-bezier(.24,.9,.32,1.4)] md:focus:before:border-slate-6 md:hover:before:border-slate-6',
                  {
                    'lg:ml-6': index % 3 === 0,
                    'lg:mx-3': index % 3 === 1,
                    'lg:mr-6': index % 3 === 2,
