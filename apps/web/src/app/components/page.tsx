    ...
    <div className="relative mx-auto flex max-w-full flex-col px-4 text-sm text-zinc-400 h-screen-ios md:max-w-7xl">
      ...
      <PageTransition className="pb-10" key="about" tag="main">
        ...
        <div className="relative grid grid-cols-1 gap-x-4 pb-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="absolute left-1/2 top-0 h-px w-[100dvw] -translate-x-1/2 border-t border-zinc-900" />
          <div className="absolute bottom-0 left-1/2 h-px w-[100dvw] -translate-x-1/2 border-b border-zinc-900" />
            ...
            return (
              <Link
                className={classNames(
                  "group relative isolate mt-7 cursor-pointer md:before:absolute md:before:inset-0 md:before:rounded-md md:before:border md:before:border-dashed md:before:border-zinc-900 md:before:transition-colors md:before:duration-[720ms] md:before:ease-[cubic-bezier(.24,.9,.32,1.4)] md:hover:before:border-zinc-800",
                  {
                    "ml-6": index % 3 === 0,
                    "mx-3": index % 3 === 1,
                    "mr-6": index % 3 === 2,
              ...
              >
                ...
                >
                  ...
                  <div className="relative flex aspect-[2/1] items-center justify-center overflow-hidden rounded-sm border border-zinc-900">
                  ...
                  <h3 className="relative z-[2] mt-4 font-semibold capitalize leading-7 text-zinc-50">
                    {category.name}
                  </h3>
                  <span className="relative z-[2] mt-1 text-xs text-zinc-500">
