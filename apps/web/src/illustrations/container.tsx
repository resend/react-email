...
const IllustrationContainer: React.FC = () => (
  <div className="relative flex w-[40%] items-center rounded-full bg-[#0D0E0E] p-3 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:skew-x-2">
    <ChevronLeftIcon
