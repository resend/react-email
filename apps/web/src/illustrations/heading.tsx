const IllustrationHeading: React.FC = () => (
  <div className="relative flex w-[40%] flex-col items-center gap-2 rounded-md bg-gradient-to-b from-transparent via-black/20 to-black/20 bg-[#0F0F10] px-2 pb-4 pt-2 shadow-sm">
