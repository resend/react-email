const IllustrationTimeline: React.FC = () => (
  <div className="group-hover:-skew-x-6 relative overflow-hidden flex w-[40%] translate-y-3 flex-col gap-2 rounded-sm bg-[#260D30] bg-linear-to-b from-transparent to-black/20 p-4 pt-5 shadow-xs transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)]">
