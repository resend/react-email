...
export default function Illustration() {
  return (
    <div className="relative flex w-[32%] translate-y-3 flex-col gap-1.5 rounded-md bg-linear-to-b from-transparent via-black/20 to-black/20 bg-[#0F0F10] p-4 shadow-xs transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] md:group-hover:skew-x-2">
      ...
      <MousePointer2Icon
        className="absolute -bottom-4 right-[40%] rotate-60 text-white transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:translate-x-3 group-hover:-translate-y-3"
        fill="currentColor"
        stroke="currentColor"
      />
    </div>
