export default function Illustration() {
  return (
    <div className="relative flex h-full w-[30%] items-center justify-center">
      <div className="absolute right-[-12%] top-[36%] h-12 w-[60%] rotate-2 rounded-lg bg-[#091610] p-1 opacity-100 transition-all duration-200 ease-out group-hover:-translate-y-1.5 group-hover:translate-x-2 group-hover:rotate-12 group-hover:scale-105 group-hover:opacity-80">
        <div className="absolute -bottom-1 left-[60%] h-3 w-3 -translate-x-1/2 rotate-45 rounded-[.125rem] bg-[#091610]" />
        <div className="relative h-full w-full rounded-md bg-black/20 bg-linear-to-b from-transparent via-black/20 to-black/20" />
      </div>
      <div className="absolute left-[-18%] top-[30%] h-12 w-[80%] -rotate-10 rounded-full bg-[#091F15] p-1 opacity-100 transition-all duration-200 ease-out group-hover:-translate-x-2 group-hover:-rotate-15 group-hover:scale-105 group-hover:opacity-80">
        <div className="h-full w-full rounded-full bg-black/20 bg-linear-to-b from-transparent via-black/20 to-black/20" />
