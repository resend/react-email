  ...
  return (
    <div className="relative flex w-full flex-col items-center gap-2 transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] md:group-hover:skew-x-12">
      <div className="relative flex w-[60%] items-center justify-center gap-2 rounded-full">
        <div className="md:group-hover:-translate-y-0.5 h-2 w-[10%] rounded-xs border border-[#2EBDC9] bg-[#25AEBA] shadow-[0px_0px_9px_4px_rgba(37,174,186,0.10)] transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)]" />
        <div className="md:group-hover:-translate-y-0.5 h-2 w-[10%] rounded-xs bg-slate-5 transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)]" />
        <div className="md:group-hover:-translate-y-0.5 h-2 w-[10%] rounded-xs bg-slate-5 transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)]" />
        <div className="md:group-hover:-translate-y-0.5 h-2 w-[10%] rounded-xs bg-slate-5 transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)]" />
      </div>
