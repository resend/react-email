...
const IllustrationMarketing: React.FC = () => (
  <div className="relative flex aspect-square w-[40%] flex-col items-center gap-2 rounded-md bg-gradient-to-b from-transparent via-black/20 to-black/20 bg-[#0F0F10] p-3 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:-skew-x-3">
    ...
    <div className="flex aspect-video w-full items-center gap-2">
      ...
      <div className="flex shrink grow basis-0 flex-col gap-1">
        ...
        <div className="h-2 w-[30%] rounded-sm bg-[#25AEBA] border border-[#2EBDC9] shadow-[0px_0px_9px_4px_rgba(37,174,186,0.10)]" />
      </div>
    </div>
  </div>
);
