const IllustrationMarkdown: React.FC = () => (
  <div className="relative flex aspect-square w-[40%] flex-col gap-2 rounded-md bg-gradient-to-b from-transparent via-black/20 to-black/20 bg-[#0F0F10] p-6 pr-3 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:skew-x-2">
