const IllustrationMarkdown: React.FC = () => (
  <div className="relative flex aspect-square w-[40%] flex-col gap-2 rounded-md bg-[#0D0E0E] p-6 pr-3 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:skew-x-2">
    ...
    <div className="h-2 w-[84%] rounded-sm bg-slate-2" />
