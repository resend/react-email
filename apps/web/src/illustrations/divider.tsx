const IllustrationDivider: React.FC = () => (
  <div className="relative flex w-[40%] flex-col items-center gap-5 rounded-sm bg-[#0D0E0E] p-3 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:skew-x-3">
