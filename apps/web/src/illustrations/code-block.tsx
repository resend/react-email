const IllustrationCodeBlock: React.FC = () => (
  <div className="relative flex aspect-square w-[40%] flex-col gap-2 rounded-md bg-gradient-to-b from-transparent via-black/20 to-black/20 bg-[#0F0F10] p-4 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:skew-x-2">
    ...
    <div className="h-1 w-[24%] rounded-sm bg-slate-7 transition-colors ease-in-out group-hover:bg-[#25AEBA] shadow-[0px_0px_9px_4px_rgba(37,174,186,0.10)]" />
    <div />
    <div />
