const IllustrationFeatures: React.FC = () => (
  <>
    ...
    <div className="relative flex w-[42%] flex-col gap-2 rounded-md bg-gradient-to-b from-transparent via-black/20 to-black/20 bg-[#0F0F10] px-2 pb-3 pt-2 shadow-sm transition-all duration-300 ease-[cubic-bezier(.36,.66,.6,1)] group-hover:-skew-x-2 group-hover:bg-[#171717]">
      ...
      <div className="mt-1 h-3 w-[30%] rounded-sm bg-[#25AEBA] border border-[#2EBDC9] shadow-[0px_0px_9px_4px_rgba(37,174,186,0.10)]" />
    </div>
  </>
);
