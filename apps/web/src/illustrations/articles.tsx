const IllustrationArticles: React.FC = () => (
  <div className="relative flex aspect-square w-[40%] translate-y-3 flex-col items-center gap-2 rounded-md bg-slate-3 px-2 pb-4 pt-2 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:skew-x-2">
