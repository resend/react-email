const IllustrationText: React.FC = () => (
  <div className="relative flex w-[40%] translate-y-3 flex-col gap-2 rounded-md bg-[#0D0E0E] p-2 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)] group-hover:-skew-x-6">
