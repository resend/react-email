const IllustrationFooters: React.FC = () => (
  <div className="group-hover:-skew-x-2 relative flex aspect-video w-[72%] translate-y-6 items-center gap-5 rounded-md bg-[#0F0F10] bg-gradient-to-b from-transparent via-black/20 to-black/20 px-6 pt-2 pb-4 shadow-sm transition-transform duration-150 ease-[cubic-bezier(.42,0,.58,1.8)]">
