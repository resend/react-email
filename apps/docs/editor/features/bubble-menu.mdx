...
<CardGroup cols={2}>
  <Card title="Bubble Menu" icon="code" href="https://github.com/resend/react-email/tree/main/packages/editor/examples/src/examples/bubble-menu.tsx">
    Default bubble menu with text selection.
  </Card>
  <Card title="Custom Bubble Menu" icon="code" href="https://github.com/resend/react-email/tree/main/packages/editor/examples/src/examples/custom-bubble-menu.tsx">
