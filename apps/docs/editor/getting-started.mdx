...
This renders a functional editor, but it's unstyled. To style the editor,
...
You can also build your own theme to style the editor to look and feel like
your own app — see [styling](/editor/features/styling).
