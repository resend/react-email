...
The editor ships CSS for its UI components, as well as a default theme. Import the styles you need:

```tsx
// Required for bubble menu styling (includes text, link, button, and image menus)
