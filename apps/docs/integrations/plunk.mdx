...
Get the [react-email](https://www.npmjs.com/package/react-email) package and the [Plunk Node.js SDK](https://www.npmjs.com/package/@plunk/node).

<CodeGroup>

```sh npm
npm install @plunk/node react-email
```

```sh yarn
yarn add @plunk/node react-email
```

```sh pnpm
pnpm add @plunk/node react-email
```
