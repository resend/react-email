...
Get the [react-email](https://www.npmjs.com/package/react-email) package and the [SendGrid Node.js SDK](https://www.npmjs.com/package/@sendgrid/mail).
...
```sh yarn
yarn add @sendgrid/mail react-email
```

```sh pnpm
pnpm add @sendgrid/mail react-email
```
