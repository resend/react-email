...
<Info>Azure Communication Email expects the sender in the `senderAddress` field. This example reads `AZURE_EMAIL_FROM` and maps it to the field Azure requires.</Info>
