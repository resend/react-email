...
[Resend Templates](https://resend.com/blog/introducing-templates) are a great way to collaborate on emails with your team, even if they're not technical. Upload a React Email Template to Resend and your entire team can collaborate in real-time in the visual editor. Then, send emails without any additional code changes.
