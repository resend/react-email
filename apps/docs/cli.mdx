...
<ResponseField name="--esbuild-plugins" type="string">
  Path to a module whose default export is an array of [esbuild plugins](/guides/esbuild-plugins), or a function returning one, to run when bundling your templates.
</ResponseField>
