...
<Info>
  ...
  - When your email platform requires you do manual templating, such as when writing custom Shopify email templates.

  You also don't have to worry much about `render` being slow as it should only be milliseconds
  in difference when compare to manual templating.
</Info>
