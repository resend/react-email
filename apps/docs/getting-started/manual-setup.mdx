...
```sh npm
npm install @react-email/preview-server -D -E
npm install react-email react react-dom -E
```

```sh yarn
yarn add @react-email/preview-server -D -E
yarn add react-email react react-dom -E
```

```sh pnpm
pnpm add @react-email/preview-server -D -E
pnpm add react-email react react-dom -E
```

```sh bun
bun add @react-email/preview-server -D -E
