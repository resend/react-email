...
Install the React Email package to the `transactional` workspace with our components:
...
<Card title="Pnpm Turborepo workspaces example" icon="arrow-up-right-from-square" href="https://github.com/resend/react-email-turborepo-pnpm-example">
  See full working source code
</Card>
