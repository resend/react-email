...
```sh npm
npm install react-email @react-email/button @react-email/components -E
```

```sh yarn
yarn add react-email @react-email/button @react-email/components -E
```

```sh pnpm
pnpm add react-email @react-email/button @react-email/components -E
```
